...
<head>
    ...
    <title>Diário de Bordo | Donizete Brandão</title>
    ...
    <div id="wrapper">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <h2 class="text-primary text-center mt-5">Diário de Bordo</h2>
                    <hr>
                    <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        ...
                        <?php endif ?>
                        <div class="action mb-2">Quer criar uma conta? <a href="registro.php">Cadastro</a></div>
                        <button type="submit" class="btn btn-secondary">Iniciar Sessão</button>
                    </form>
                </div>
            </div>
        </div>
